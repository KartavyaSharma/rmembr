...
export default function indexPage() {
  ...
  return (
    <section>
      ...
      <div className="h-full w-full bg-cover bg-fixed bg-gray-900 relative">
        <div
        ...
        <div className="flex w-full justify-center">
          <div className="px-8 py-32 max-w-[90rem] h-full z-50 justify-center items-center">
            <div className="grid justify-items-middle min-h-full">
              ...
              <div className="grid grid-rows-1 justify-items-stretch">
                <div className="font-montserrat text-md lg:text-lg 2xl:text-xl font-light text-gray-600 p-3 pb-5 align-middle justify-self-center justify-center w-full lg:w-1/2">
                  ...
                  >
                    ...
                    coursework planning process. With rmembr you can keep track
                    of your active recall progress, plan office hours, and
                    record practice questions. All in one place.
                  </div>
                </div>
              </div>
              <div className="flex w-full my-5 justify-center z-[100]">
                ...
                >
                  <a
                    className="relative inline-flex items-center px-4 xl:px-6 py-2 overflow-hidden text-gray-600 border-2 border-current rounded group active:text-gray-600 focus:outline-none focus:none"
