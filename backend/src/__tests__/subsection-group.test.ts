...
describe("Subsection Group Test", () => {
    ...
    it.todo("User's course should have an emply list of subsections");

    it.todo("Add a subsection to a section");

    it.todo("Delete a subsection group");

    it.todo("Retrive a subsection group");

    it.todo("Retrieve an invalid subsection group");
